...
# get strings
tooltip = (Silk_tooltips.ControlGrid66_baseTip + Silk_tooltips.standardTipFooter)
moreInfo = (Silk_tooltips.ControlGrid66_baseTip + Silk_tooltips.ControlGrid66_moreInfo)

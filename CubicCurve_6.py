...
# get strings
tooltip = (Silk_tooltips.CubicCurve_6_baseTip + Silk_tooltips.standardTipFooter)
moreInfo = (Silk_tooltips.CubicCurve_6_baseTip + Silk_tooltips.CubicCurve_6_moreInfo)

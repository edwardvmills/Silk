...
class ControlGrid64():
	def Activated(self):
		...
		if mode=='4sided':
			...
			a=FreeCAD.ActiveDocument.addObject("Part::FeaturePython","ControlGrid64_4")
	...
	def GetResources(self):
		return {'Pixmap' :  FreeCAD.__path__[3] + '\Silk\Resources\Icons\ControlGrid64.svg', 'MenuText': 'ControlGrid64', 'ToolTip': 'ControlGrid64'}

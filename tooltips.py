...
ControlGrid66_moreInfo = (
    ...
    "ControlGrid44s at preset locations (in a 3 by 3 pattern like tic-tac-toe). This is an exact conversion with no loss of precision. These nine \n"
    "pieces will then be workable through all the tools available for ControlGrid44s and CubicSurface_44s. \n"
    )
